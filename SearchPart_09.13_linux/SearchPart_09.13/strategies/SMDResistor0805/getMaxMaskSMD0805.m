...
function [parts,position,valueOut]=getMaxMaskSMD0805(I,scale_factor_zoom,mapH,mapV,maskpos,numparts,tol,treshold)
...
mask=imresize(mask,0.8399*(1/scale_factor_zoom));
