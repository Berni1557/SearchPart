...
componentListTemp{end+1}=Component('ComponentID',4,'Strategy',PCI2_Strategy('duratione',15),'Componentname','PCI2','HasDatasheet',false);
...
componentListTemp{end+1}=Component('ComponentID',6,'Strategy',SMDResistor0603_Strategy('duratione',70),'Componentname','SMDResistor0603','HasDatasheet',false);
componentListTemp{end+1}=Component('ComponentID',7,'Strategy',SMDResistor0805_Strategy('duratione',70),'Componentname','SMDResistor0805','HasDatasheet',false);
...
% componentListTemp{end+1}=Component('ComponentID',6,'Strategy',dummy_Strategy('duratione',5),'Componentname','DummyComponent','HasDatasheet',false);
