...
function varargout = GUIclose(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GUIclose_OpeningFcn, ...
                   'gui_OutputFcn',  @GUIclose_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUIclose is made visible.
function GUIclose_OpeningFcn(hObject, eventdata, handles, varargin)
Session=varargin{1};
...
% Choose default command line output for GUIclose
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GUIclose wait for user response (see UIRESUME)
...
function varargout = GUIclose_OutputFcn(hObject, eventdata, handles) 
